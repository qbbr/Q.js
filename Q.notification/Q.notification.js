 ...
 */
if(!Q)var Q={};Q.notification={sec:4,backgroundColor:"#333",color:"white",show:function(t){this.c();b=document.createElement("div");b.style.position="fixed";b.style.top="10px";b.style.right="10px";b.style.backgroundColor=this.backgroundColor;b.style.color=this.color;b.style.padding="5px 10px";b.style.borderRadius="5px";b.style.MozBorderRadius="5px";b.style.cursor="help";try{Q.opacity.set(b,0.7);}catch(e){}b.innerHTML=t;b.onclick=function(){Q.notification.c();}
